...
{
    public class GetOrdersMappingTest : IClassFixture<AutoMapperFixture>
    {
        private readonly AutoMapperFixture _autoMapperFixture;

        public GetOrdersMappingTest(AutoMapperFixture autoMapperFixture)
        {
        ...
        public void MapFromResponseToDto_WhenValuesAreValid_ShouldMapAll()
        {
            ...
            // Act
            var result = _autoMapperFixture.Mapper.Map<GetOrdersDto>(response);
